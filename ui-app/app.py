...
#Overide host for Docker enviroment if enviroment variable is set
...
print(f"Using Inference API URL: {INFERENCE_API_URL}")





#Intiliaze the data manager and production database
...
app.layout = dbc.Container([
    ...
    dbc.Row([
        ...
        dbc.Col([
            ...
            dcc.Graph(id='graph-1', clear_on_unhover=True, style={#you can specify how your graph looks like here
                "backgroundColor": "#fff",
                "borderRadius": "12px",
                "padding": "8px",
                "height": "50%", 
...
def trigger_inference(n_clicks):
    ...
    try:
        ...
        return f"Error during inference: {str(e)}", False, 0       
